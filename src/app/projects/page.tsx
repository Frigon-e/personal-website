...
const Projects = [
    ...
    },
    {
        ...
        href: '#',
        description:
            'This Battleship AI is able to win in 44.1 moves on average per 100,000 games. It was made in Java for a school assignment. The average of the class was apx. 47-50 moves.',
        imageUrl:
                                ...
                                <div className="flex flex-1 flex-col justify-between bg-zinc-800/90 p-6">
                                    <div className="flex-1">
                                        <a href={post.href} className="mt-2 block">
                                            <p className="text-xl font-bold bg-gradient-to-tr from-pink-500 to-rose-500 bg-clip-text text-transparent">{post.title}</p>
