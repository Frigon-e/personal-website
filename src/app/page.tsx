...
const Tech_Grid = () => {
    return (
        <div className="divide-y divide-gray-200 overflow-hidden sm:rounded-lg shadow grid grid-cols-3 border-t border-grey-200 sm:border-none sm:pt-0 sm:gap-1 divide-y-0">
                    ...
                    <li key={roleIndex} className="flex gap-4">
                        ...
                        <dl className="flex flex-auto flex-wrap gap-x-2">
                            ...
                            <dd
                                ...
                                aria-label={`${typeof role.issue !== "string" ? role.issue.label : role.issue} until ${
